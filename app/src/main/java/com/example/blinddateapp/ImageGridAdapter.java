...
public class ImageGridAdapter extends BaseAdapter {
    ...
    public ImageGridAdapter(LayoutInflater inflater, ViewGroup container, SecondTab context, int[] imageIDs) {
...
//
            ImageClickListener imageViewClickListener
                    = new ImageClickListener(context.getContext(), imageIDs[position]);
